...
<body class="bg-default">
    ...
    <div class="d-flex justify-content-center align-items-center" style="padding-top:150px">
        <div class="container bg-cnt br-25 log-cont" style="width:35%;">
            <form method="POST" action="../src/editarUser.php">
                ...
                <div class="row">
                    <div class="col">
                        <div class="row">
                            ...
                            <?php
                                if(isset($row_result['nome_user'])){
                                    echo($row_result['nome_user']);
                                }
                            ?>"></input>
                        </div>
                        <div class="row">
                            <label class="txt-dft">Email:</label>
                            <input style="width:85%;margin-left:15px;margin-top:5px;" type="email" name="email" value="
                            <?php
                                if(isset($row_result['email_user'])){
                                    echo($row_result['email_user']);
                                }
                            ?>"></input>
                        </div>
                    </div>
                    <div class="col" >
                        <div class="row" style="padding-top:25px">
                            <label class="txt-dft">Permissão:</label>
                            <select id="perm" name="perm" style="height:38px;">
                                <option value="0">Aluno</option>
                                <option value="1">Admin</option>
                            </select>
                        </div>
                        <div class="row justify-content-center"  >
                            <input name="editaUser" type="submit" style="margin-top:25px;width:50%;border:0px" value="Salvar"></input>
                        </div>
                    </div>
                </div>
            </form>
