...
<body class="bg-default">
    <div class="bg-image d-flex justify-content-center align-items-center">
        <div class="container bg-cnt br-25 log-cont">
            <form id="log_user" name="log_user" method="POST" action="" enctype="multipart/formdata">
                ...
                <div class="log-row text-center log-btn">
                    <input type="submit" class="btn btn-log br-15" value="Logar" name="logarUser">
                </div>
                <div class="log-row text-center log-criar-cnt">
                    <a class="crt-cnt" href="register.php">Criar conta</a>
                </div>
                <div class="log-row text-center log-criar-cnt">
